...
window.onload = function init()
{
    ...
    canvas.addEventListener("mousedown", function (e) {
        ...
        var near = view2world.times(proj2view).times(clip2proj).times(canvas2clip).times(new PV(cursorX, cursorY, -1, true)).homogeneous();
        var far = view2world.times(proj2view).times(clip2proj).times(canvas2clip).times(new PV(cursorX, cursorY, 1, true)).homogeneous();

        // Call body.closestHit and set closestHit above.
        closestHit = body.closestHit(near, far);
